  ...
  <div class="wrapper text-center">
   <div class="container">
     ...
     <div class="jumbotron foo-1">
       ...
       <div class="skills">
        <h2>Me chamo Jackson Pereira, tenho 24 anos, sou formado em Sistemas de Informação e trabalho como <b>Desenvolvedor Web</b> (Atualmente na Faculdade de Ciências Humanas - <b>ESUDA</b> ), aqui estão algumas de minhas <b>Habilidades:</b></h2>
        <ul>
         <li>• HTML</li>
         <li>• CSS</li>
         <li>• JQuery</li>
